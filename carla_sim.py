...
from automated_driving.util.geometry_util import dist_point_linestring
import argparse
...
def main(use_lane_detector=True, ex=False):
    from automated_driving.lane_detection.lane_detector import LaneDetector
    from automated_driving.lane_detection.camera_geometry import CameraGeometry
    from automated_driving.control.pure_pursuit import PurePursuitPlusPID
